...
// Check if project is completed and current user is the seller - show release funds button
$current_user_id = get_current_user_id();
$show_release_button = ($proposal_status === 'completed' && $current_user_id === $seller_id);

// Debug logging
error_log('Release Funds Button Check:');
error_log('Current User ID: ' . $current_user_id);
error_log('Seller ID: ' . $seller_id);
error_log('Proposal Status: ' . $proposal_status);
error_log('Show Release Button: ' . ($show_release_button ? 'YES' : 'NO'));
...
<!-- Success Modal for Merchant Release Funds -->
